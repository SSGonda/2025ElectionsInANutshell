...
<section class="mt-10 mb-30 flex flex-col items-center justify-center gap-6 align-middle">
	<h1 class="text-center text-7xl font-bold">Plots</h1>
...
<section class="flex flex-col items-center justify-center gap-2 align-middle">
	<div class="flex max-w-4xl flex-col gap-3">
		...
		<h1 class="text-3xl font-semibold">Context of the Sentiments Dataset</h1>
		<p>
...
Positive        7        7         2     5 
		...
		<section class="space-y-4">
			<div>
				<h2 class="font-semibold">Null</h2>
				<p>
			...
			<div>
				<h2 class="font-semibold">Alternative</h2>
				<p>
			...
			<div>
				<h2 class="font-semibold">Conclusion</h2>
		...
		<h1 class="text-2xl font-semibold">Research Questions</h1>
		...
		<figure class="flex flex-col justify-center">
			<img class="self-center-safe" src="{base}/image6.png" alt="Tone Counts Plot" />
			<figcaption class="text-center font-light">
		...
		<figure class="flex flex-col justify-center">
			<img class="self-center-safe" src="{base}/image13.png" alt="Polarities Counts Plot" />
			<figcaption class="text-center font-light">
