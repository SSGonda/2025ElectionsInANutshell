...
<section class="mt-30 mb-10 flex flex-col items-center justify-center gap-4 align-middle">
	<h1 class="text-center font-[HomeVideoBold-R90Dv] text-7xl text-[55px]">Our Plots.</h1>
	...
	<Button href="{base}/" size="sm" variant="outline" class="font-[HomeVideo-ABLG6G]"
		>Go Back Home</Button
	>
</section>

<section class="font-[HomeVideo-ABLG6G]">
	<div class="mr-[50px] mb-[95px] ml-[50px] flex h-[500px] flex-row text-right">
		<div class="flex-1 content-center border-r-2 border-r-white">
			<div class="m-[10px] flex">
				<div class="mr-[10px] h-[31px] w-[55px] justify-center rounded-[10px] bg-[#d9d9d9]">
					<p class="text-center text-[20px] text-[#190a2f]">1.</p>
				</div>
			...
			<div class="m-[10px] flex">
				<div class="mr-[10px] h-[31px] w-[55px] justify-center rounded-[10px] bg-[#d9d9d9]">
					<p class="text-center text-[20px] text-[#190a2f]">2.</p>
				</div>
			...
			<div class="m-[10px] flex">
				<div class="mr-[10px] h-[31px] w-[55px] justify-center rounded-[10px] bg-[#d9d9d9]">
					<p class="text-center text-[20px] text-[#190a2f]">3.</p>
				</div>
			...
			<div class="m-[10px] flex">
				<div class="mr-[10px] h-[31px] w-[55px] justify-center rounded-[10px] bg-[#d9d9d9]">
					<p class="text-center text-[20px] text-[#190a2f]">4.</p>
				</div>
				<p class="text-[20px]">the 'perceived judgement' of a user</p>
			</div>
		</div>

		<div class="flex h-[384px] w-[626px] flex-col">
			<p class="text-[40px]">
				Context of the <br />
				Sentiments Dataset
			</p>
	...
	<div class="mb-25 flex flex-row bg-[#190a2f] inset-shadow-2xs">
		<div class="w-385 content-center">
			<p class="border-r-2 border-r-white text-center text-[40px]">
	...
	<div class="mb-25 flex flex-row p-5">
		<div class="w-[700px] border-r-2 border-r-white p-10">
		...
		<div class="content-center">
			...
			<div class=" m-2 w-[550px] content-center rounded-[10px] bg-[#d9d9d93f] p-2">
				<pre class="text-[15px] whitespace-pre-wrap">
			...
			<div class=" m-2 w-[550px] content-center rounded-[10px] bg-[#b02465] p-2">
			...
			<div class=" m-2 w-[550px] content-center rounded-[10px] bg-[#392cad] p-2">
				<pre class="whitespace-pre-wrap">
	...
	<div class="mb-20 flex flex-row bg-[#1b1757]">
		<div>
			<h2 class="p-2 text-[20px] underline">Correlation Tests</h2>
		...
		<div class=" content-center bg-[#190a2f]">
			<h2 class="text-center text-[35px] underline">Conclusion</h2>
			<div class="flex w-[365px] flex-col p-3 text-center">
	...
	<div class="content-center">
		<h1 class="mb-[45px] text-center text-2xl text-[40px] underline">Our Research Questions</h1>
		<h2 class="ml-[80px] w-[800px] border-l-2 border-white p-4 text-xl">
	...
	<div class="p-20">
		<div class="flex flex-row content-center">
			<figure class=" flex flex-col content-center border-r-2 border-b-2 border-amber-50">
				<img class="" src="{base}/image6.png" alt="Tone Counts Plot" />
				<figcaption class="p-2 text-center text-[10px] font-light">
					Figure 3. Tone counts across the entire dataset containing the sentiments of each tweet.
				</figcaption>
			</figure>

			<div class="w-[740px] border-2 p-3 text-right">
				<p class="text-[20px]">neutral is most common</p>
				<p>
		...
		<div class="flex h-[428px] flex-row">
			<div class="w-[880px] border-2 p-3 text-right">
				<p class="text-left text-[20px]">neutral is most common</p>
				<p class="text-left">
					<br />In the case that multiple candidates were mentioned in a tweet, a list will be
					returned containing the corresponding tone, polarity, and judgement per candidate
					mentioned in that tweet. The particular model,
			...
			<div>
				<figure class="flex flex-col border-t-2 border-l-2 border-amber-50">
	...
	<div class="p-20">
		<div class=" flex flex-row">
			<div class="w-[880px] border-b-2 border-l-2 border-amber-50 p-5 text-right">
				<p class="text-left text-[20px] underline">emotions are conditional</p>
				<p class="text-left">
					<br />In the case that multiple candidates were mentioned in a tweet, a list will be
					returned containing the corresponding tone, polarity, and judgement per candidate
					mentioned in that tweet. The particular model,
		...
		<div class="flex flex-row">
			<div class="w-[755px] border-l-2 border-amber-50 p-5 text-right">
				<p class="text-left text-[20px] underline">neutral is most common</p>
				<p class="text-left">
					<br />In the case that multiple candidates were mentioned in a tweet, a list will be
					returned containing the corresponding tone, polarity, and judgement per candidate
					mentioned in that tweet. The particular model,
	...
	<h2 class="ml-[80px] border-l-2 border-amber-50 p-4 text-xl">
	...
	<div class=" p-15">
		<div class="mb-[20px] flex flex-row">
			<div class="w-[650px] border-r-2 border-b-2 border-amber-50 p-5">
				...
				<div class=" w-[500px] p-5 text-right">
					<p class="text-left text-[20px] underline">neutral is most common</p>
			...
			<div class="w-[525px] border-b-2 border-amber-50">
				<figure class="flex flex-col">
					<img
						class="self-center"
						src="{base}/image8.png"
		...
		<div class="flex flex-row p-3">
			<figure class="flex flex-col justify-center">
				...
				<figcaption class="text-center text-[10px] font-light">
	...
	<div class="p-20">
		...
		<div class="flex flex-row">
			...
			<div class="w-[835px] border-l-2 border-amber-50 p-5 text-right">
				<p class="text-left text-[20px] underline">neutral is most common</p>
				<p class="text-left">
					<br />In the case that multiple candidates were mentioned in a tweet, a list will be
					returned containing the corresponding tone, polarity, and judgement per candidate
	...
	<div>
		<div class="flex flex-row">
			...
			<div class="w-[880px] p-5 text-right">
				<p class="text-left text-[20px] underline">neutral is most common</p>
				<p class="text-left">
					<br />In the case that multiple candidates were mentioned in a tweet, a list will be
					returned containing the corresponding tone, polarity, and judgement per candidate
	...
	<h2 class="mt-[50px] ml-[80px] border-l-2 border-amber-50 p-4 text-xl">
		Are we able to predict the influence of social media on nationwide elections?
	</h2>
	<p class="ml-[60px] p-10">To be answered in the modelling stage</p>

	<div class="h-[150px] w-[1350px] bg-[#190a2f]">
		<p class="p-[20px] text-center">references found at documentation.</p>
	</div>
