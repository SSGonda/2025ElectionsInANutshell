<script>
	...
	onMount(async () => {
		if (browser) {
			...
			if (document.getElementById('0fd01541-8b40-4523-ba6c-e05f529a96ec')) {
				Plotly.newPlot(
					'0fd01541-8b40-4523-ba6c-e05f529a96ec',
					[
						{
							domain: { x: [0.0, 1.0], y: [0.0, 1.0] },
							hovertemplate:
								'mentioned_candidate_AI=%{label}\u003cbr\u003ecount=%{value}\u003cextra\u003e\u003c\u002fextra\u003e',
							labels: [
								'kiko pangilinan',
								'bam aquino',
								'heidi mendoza',
							...
							name: '',
							showlegend: true,
							values: [151, 138, 56, 28, 20, 16, 14, 13, 13, 13, 128],
							type: 'pie'
						}
					],
					{
...
<div>
	<div
		id="0fd01541-8b40-4523-ba6c-e05f529a96ec"
