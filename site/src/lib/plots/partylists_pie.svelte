<script>
	...
	onMount(async () => {
		if (browser) {
			...
			if (document.getElementById('40ea454b-fb14-4b19-a2c0-05a84a12d114')) {
				Plotly.newPlot(
					'40ea454b-fb14-4b19-a2c0-05a84a12d114',
					[
						{
							...
							name: '',
							showlegend: true,
							values: [55, 20, 19, 12, 10, 9, 8, 7, 5, 4, 22],
							type: 'pie'
						}
					],
					{
...
<div>
	<div
		id="40ea454b-fb14-4b19-a2c0-05a84a12d114"
